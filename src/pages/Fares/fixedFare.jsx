...
export default function CreateFixedFaresSettings() {
            ...
            <div className="w-full flex justify-center mt-5">
                ...
                >
                    ...
                    <div className="flex justify-center">
                        ...
                        <h1 className="text-3xl mb-5 ">Fixed Fares</h1>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                        ...
                        {/* From Location Type */}
                        <Form.Item label="From Location Type" name="fromLocationType">
                            <Select placeholder="Select From Location Type">
                                <Option value="normalDays">Normal Days</Option>
                                <Option value="specialDays">Special Days</Option>
                            </Select>
                        </Form.Item>
                        ...
                        {/* To Location Type */}
                        <Form.Item label="To Location Type" name="toLocationType">
                            <Select placeholder="Select To Location Type">
                                <Option value="normalDays">Normal Days</Option>
                                <Option value="specialDays">Special Days</Option>
                            </Select>
                        </Form.Item>
